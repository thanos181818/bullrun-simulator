...
export const mockBadges: Badge[] = [
  ...
  },
  {
    ...
    icon: 'TrendingUp',
    unlockedIcon: 'TrendingUp',
    rarity: 'epic',
  },
];

export const baseAssets: (Omit<Asset, 'price' | 'change' | 'changePercent'> & { ipoDate: number })[] = [
  { symbol: 'AAPL', name: 'Apple Inc.', marketCap: 2800000000000, type: 'stock', initialPrice: 185.20, ipoDate: new Date('1980-12-12').getTime() },
  ...
  { symbol: 'BTC', name: 'Bitcoin', marketCap: 830000000000, type: 'crypto', initialPrice: 42500.00, ipoDate: new Date('2013-01-01').getTime(), coingeckoId: 'bitcoin' },
  { symbol: 'ETH', name: 'Ethereum', marketCap: 276000000000, type: 'crypto', initialPrice: 2300.00, ipoDate: new Date('2015-07-30').getTime(), coingeckoId: 'ethereum' },
  { symbol: 'SOL', name: 'Solana', marketCap: 30000000000, type: 'crypto', initialPrice: 75.50, ipoDate: new Date('2020-04-10').getTime(), coingeckoId: 'solana' },
  { symbol: 'XRP', name: 'XRP', marketCap: 32000000000, type: 'crypto', initialPrice: 0.62, ipoDate: new Date('2013-08-04').getTime(), coingeckoId: 'ripple' },
  { symbol: 'ADA', name: 'Cardano', marketCap: 14000000000, type: 'crypto', initialPrice: 0.40, ipoDate: new Date('2017-10-01').getTime(), coingeckoId: 'cardano' },
  { symbol: 'DOGE', name: 'Dogecoin', marketCap: 22000000000, type: 'crypto', initialPrice: 0.08, ipoDate: new Date('2013-12-06').getTime(), coingeckoId: 'dogecoin' },
  { symbol: 'MATIC', name: 'Polygon', marketCap: 8500000000, type: 'crypto', initialPrice: 0.85, ipoDate: new Date('2019-04-28').getTime(), coingeckoId: 'matic-network' },
  { symbol: 'AVAX', name: 'Avalanche', marketCap: 12000000000, type: 'crypto', initialPrice: 65.75, ipoDate: new Date('2020-09-21').getTime(), coingeckoId: 'avalanche-2' },
  { symbol: 'LINK', name: 'Chainlink', marketCap: 16000000000, type: 'crypto', initialPrice: 15.25, ipoDate: new Date('2017-09-19').getTime(), coingeckoId: 'chainlink' },
  { symbol: 'UNI', name: 'Uniswap', marketCap: 9500000000, type: 'crypto', initialPrice: 6.30, ipoDate: new Date('2020-09-17').getTime(), coingeckoId: 'uniswap' },
];
